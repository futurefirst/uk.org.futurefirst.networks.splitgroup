 ...
 */
function splitgroup_civicrm_postInstall() {
  _splitgroup_civix_civicrm_postInstall();
}
 ...
 */
function splitgroup_civicrm_entityTypes(&$entityTypes) {
  _splitgroup_civix_civicrm_entityTypes($entityTypes);
}

/**
 * Implements hook_civicrm_themes().
 */
function splitgroup_civicrm_themes(&$themes) {
  _splitgroup_civix_civicrm_themes($themes);
}
